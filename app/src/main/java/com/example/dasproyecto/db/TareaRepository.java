...
public class TareaRepository {
    ...
    public boolean sincronizar(int usuarioId) {
        try {
            ...
            android.content.Intent intent = new android.content.Intent(context, com.example.dasproyecto.TareasWidgetProvider.class);
            intent.setAction(android.appwidget.AppWidgetManager.ACTION_APPWIDGET_UPDATE);
            int[] ids = android.appwidget.AppWidgetManager.getInstance(context)
                    .getAppWidgetIds(new android.content.ComponentName(context, com.example.dasproyecto.TareasWidgetProvider.class));
