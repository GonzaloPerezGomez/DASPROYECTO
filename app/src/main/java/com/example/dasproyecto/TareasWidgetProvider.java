...
import com.example.dasproyecto.db.AppDatabase;
import com.example.dasproyecto.db.TareaDao;
import com.example.dasproyecto.db.TareaEntity;
    ...
    private void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        if (tareas.isEmpty()) {
            ...
            if (tareas.size() > 0) {
                ...
                views.setTextViewText(R.id.widget_tarea1_fecha, com.example.dasproyecto.db.DBmanager.formatFechaToUI(tareas.get(0).fechaLimite));
            }
            if (tareas.size() > 1) {
                ...
                views.setTextViewText(R.id.widget_tarea2_fecha, com.example.dasproyecto.db.DBmanager.formatFechaToUI(tareas.get(1).fechaLimite));
            }
            if (tareas.size() > 2) {
                ...
                views.setTextViewText(R.id.widget_tarea3_fecha, com.example.dasproyecto.db.DBmanager.formatFechaToUI(tareas.get(2).fechaLimite));
            }
        }
